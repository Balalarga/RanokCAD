...
public:
	...
	LanguageDefinition& EditLanguageDefinition()
	{
		return mLanguageDefinition;
	}
	...
	const Palette& GetGruvboxPalette();
...
private:
	...
	public:
		...
		void Undo(TextEditorWidget* aEditor);
		void Redo(TextEditorWidget* aEditor);
	...
	float mTextStart; // position (in pixels) where a code line starts relative to the left of the TextEditorWidget.
	int mLeftMargin;
