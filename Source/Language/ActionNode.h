...
public:
	...
	std::vector<std::shared_ptr<ActionNode>>& Nodes()
	{
		return _nodes;
	}
	...
	std::map<std::string, VariableDeclarationNode*>& Variables()
	{
		return _variables;
	}
	...
	std::vector<ActionNode*>& DeclarationOrder()
	{
...
public:
	...
	const std::vector<ActionNode*>& Values() const
	{
		return _values;
	}
...
public:
	...
	const std::vector<ActionNode*>& Arguments() const
	{
		return _arguments;
	}

	FunctionDeclarationNode* Root() const
	{
		return _root;
	}
